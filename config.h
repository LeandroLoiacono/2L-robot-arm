...
#define END_EFFECTOR_OFFSET 55.0 //for pen holder 55.0 // LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
#define X_HOME_STEPS 860 //700 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
