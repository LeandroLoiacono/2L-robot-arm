...
#define END_EFFECTOR_OFFSET 40.0 //for pen holder 55.0 // LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
#define INITIAL_Y (SHANK_LENGTH + END_EFFECTOR_OFFSET) // CARTESIAN COORDINATE Y (= SHANK_LENGTH + END_EFFECTOR_OFFSET)
...
#define X_HOME_STEPS 915 //700 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1985//1840 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
#define Z_HOME_STEPS 3850//3650 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
#define E0_HOME_STEPS 0 // STEPS FROM E0_ENDSTOP TO INITIAL_E0

//HOMING SETTINGS:g28

#define HOME_X_STEPPER true // "true" IF ENDSTOP IS INSTALLEDM18
...
//MIN & MAX POSITIONS:
#define Z_MIN -125.0
#define Z_MAX (SHANK_LENGTH+50.0)
