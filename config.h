...
#define INITIAL_Y 200.0 // CARTESIAN COORDINATE Y (= SHANK_LENGTH + END_EFFECTOR_OFFSET)
...
#define X_HOME_STEPS 1050 //700 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM
#define Y_HOME_STEPS 1840 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM
...
//STEPPER SETTINGS:
#define MICROSTEPS 16// 16 MICROSTEPPING CONFIGURATION ON RAMPS1.4
...
//MIN & MAX RADIUS:
#define R_MIN 170.0
#define R_MAX 310.0 //theoretically should be 320 (LOWER_LENGTH + SHANK_LENGTH + END_EFFECTOR_OFFSET) by the arm canno stretch fully
